...
public class CustomerController {
	...
	public ResponseEntity<?> seeAllProposedPolicies(@RequestParam int customer_id, ResponseMessageDto dto)
	{
...
//		}
		...
		List<Object> list=customerService.findallproposedpolicies(customer_id);
		return ResponseEntity.ok(list);
	}
